    ...
    if 'sources' in event:
        ...
        if event['classification']=='Moties':
            ...
            for source in event['sources']:
                localid=source['url']
                try:document=source['description']
                except:document=event['name']
...
#save data
try:
    with open("C:/Users/Kraan/Git/ORI/total_dh.json", "w") as f:
        json.dump(total_data, f)
except:
    with open("C:/Users/Jaap/Git/ORI/total_dh.json", "w") as f:
        json.dump(total_data, f)
